...
const textmateRegistry = atom.grammars.textmateRegistry || atom.grammars;
...
function semanticolorGrammarFactory(grammar, defaults, options, colorDiversity) {
	...
	semanticolorGrammar.description = semanticolorGrammar.name
		+ (utils.isTreeSitter(semanticolorGrammar) ? ' (tree-sitter)' : ' (TextMate)');
	...
	debug('creating', semanticolorGrammar.description);
