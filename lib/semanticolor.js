(function() {
  ...
  module.exports = Semanticolor = {
    config: {
      ...
      saturationLevelA1: {
        type: 'integer',
        text: 'Used for generating the additional colors using @hsl',
        description: 'See README on https://atom.io/packages/semanticolor',
        minimum: 0,
        default: 100,
        maximum: 100
      },
    ...
    updateLESSStylesheet: function(){
      ...
      var sla1 = atom.config.get('semanticolor').saturationLevelA1 || 100;
      var sla2 = atom.config.get('semanticolor').saturationLevelA2 || 10;
      var slb1 = atom.config.get('semanticolor').saturationLevelB1 || 75;
      var slb2 = atom.config.get('semanticolor').saturationLevelB2 || 75;
      /*var lessUpdate = "@colorDiversity: " + cd + ';';*/
      var lessUpdate = [
        "@colorDiversity: "+cd+";",
        "@saturationLevelA1: "+sla1+"%;",
        "@saturationLevelA2: "+sla2+"%;",
        "@saturationLevelB1: "+slb1+"%;",
        "@saturationLevelB2: "+slb2+"%;"
      ].join("\n");

      /*var lessUpdate = lessUpdateArray.join("\n");*/
      console.log(lessUpdate);
      var written = false;
      try {
        ...
        if (e.code === 'ENOENT') {
            ...
            try {
              ...
              var lessUpdate = [
                "@colorDiversity: 96;",
                "@saturationLevelA1: 100%;",
                "@saturationLevelA2: 10%;",
                "@saturationLevelB1: 75%;",
                "@saturationLevelB2: 75%;"
              ].join("\n");
