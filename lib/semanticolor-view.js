(function() {
  var SemanticolorView;

  module.exports = SemanticolorView = (function() {
    function SemanticolorView(serializedState) {
      var message;
      this.element = document.createElement('div');
      this.element.classList.add('semanticolor');
      message = document.createElement('div');
      message.textContent = "The Semanticolor Color Diversity Has Changed! Reload must occur for update. Proceed?";
      ...
      button.onclick = function(){
        ...
        atom.notifications.addSuccess('Reloading...',{detail: 'Updating stylesheet with {'+colorDiversity+'} possible colors.'});
        setTimeout(function(){
          atom.reload();
        }, 2000);
      };
